...
async function main() {
   const replace_contractAddress = "0x7c8ddBF1AcD38255Bd637BcD0164455E5E5c6535";
   const [signer] = await hre.ethers.getSigners();
   const replace_contractFactory = await hre.ethers.getContractFactory("ManUtdToken");
   const contract = replace_contractFactory.attach(replace_contractAddress);
 
   const replace_functionName = "mint";
   const replace_functionArgs = ["0xd9506c619C71FADAf5826807b3Fb3C1CbACbBa37","100000000000000000000"]; // 100 tokens with 18 decimal places
